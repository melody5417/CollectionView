...
// gets called before any insert/delete animations occur.
// We can use that to record the indexPaths of those items being inserted or removed (don’t forget to call super).
